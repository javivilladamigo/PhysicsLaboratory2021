...
void KCl() {
    ...
    Float_t time = 15;
    Float_t normalization_factor = time / 29.; // 29 minutes for background and 15 minutes for KCl sample
    xMin = 0, xMax = 30000;
    ...
    TH1D *hist_NaI = getHistoForChannelFromTree("/Users/javi/Documents/Padova/1/PhysicsLaboratory/PhysicsLaboratory2021/Gamma/data/full_data/day2/samples/KCl15min_8g.root", 0, bins, xMin, xMax);
    TH1D *hist_HPGe = getHistoForChannelFromTree("/Users/javi/Documents/Padova/1/PhysicsLaboratory/PhysicsLaboratory2021/Gamma/data/full_data/day2/samples/KCl15min_8g.root", 1, bins, xMin, xMax);
    ...
    TH1D *hcal_NaI = new TH1D("hcal_NaI", "Calibrated histo of KCl (NaI)", bins, new_beg_NaI, new_end_NaI);
    TH1D *hcal_HPGe = new TH1D("hcal_HPGe", "Calibrated histo of KCl (HPGe)", bins, new_beg_HPGe, new_end_HPGe);
    TH1D *hbcal_NaI = new TH1D("hbcal_NaI", "Calibrated histo of KCl (NaI)", bins, new_beg_NaI, new_end_NaI);
    TH1D *hbcal_HPGe = new TH1D("hbcal_HPGe", "Calibrated histo of KCl (HPGe)", bins, new_beg_HPGe, new_end_HPGe);
    ...
    TCanvas *c1 = new TCanvas("c1", "KCl calibrated spectrum (NaI)");
    ...
    TCanvas *c3 = new TCanvas("c3", "KCl calibrated spectrum (HPGe)");
    ...
    hcal_HPGe->GetXaxis()->SetRangeUser(1400, 1550);
    ...
    hbcal_HPGe->Rebin(8);
    hbcal_HPGe->GetXaxis()->SetRangeUser(1400, 1550);
